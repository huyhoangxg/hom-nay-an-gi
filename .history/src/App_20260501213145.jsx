    ...
    <div className="min-h-screen flex flex-col font-sans bg-bgLight selection:bg-brand selection:text-white">
      ...
      <main id="hero" className="container mx-auto px-6 py-10 md:py-20 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div className="w-full md:w-1/2 flex flex-col items-start gap-6">
          ...
          <h1 className="text-5xl md:text-5xl lg:text-[72px] font-extrabold leading-[1.1] tracking-tight text-[#111827]">
            Để tụi này lo! 
          </h1>
        ...
        <div className="w-full md:w-1/2 relative">
          ...
          <button 
            ...
            className={`absolute bottom-4 right-4 md:-bottom-12 md:right-0 z-20 ${randomFood ? 'bg-white text-brand' : 'bg-yellow-400 text-yellow-900'} font-extrabold px-8 py-5 md:px-10 md:py-6 rounded-full flex items-center gap-3 md:gap-4 shadow-[0_20px_50px_rgba(0,0,0,0.4)] hover:scale-110 transition-all outline-none border-4 border-white/50`}
          >
