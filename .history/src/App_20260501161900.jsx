...
// DỮ LIỆU MẪU ĐÃ ĐỔI THÀNH EMAIL ĐỂ ĐỒNG BỘ VỚI FORM
const INITIAL_TESTIMONIALS = [
  { id: 1, name: "Minh Anh", subtitle: "minhanh.student@gmail.com", rating: 5, content: "Mình không còn phải mất 30 phút mỗi trưa để nghĩ ăn gì nữa! App này cứu cánh cho sinh viên như mình, vừa rẻ vừa ngon.", avatarColor: "bg-[#f97316]", avatarText: "M" },
  { id: 2, name: "Tuấn Đạt", subtitle: "tuandat.office@yahoo.com", rating: 5, content: "Giờ nghỉ trưa chỉ có 1 tiếng, app này giúp mình quyết định nhanh và luôn có gợi ý phù hợp với budget. Tuyệt vời!", avatarColor: "bg-[#eab308]", avatarText: "T" },
  { id: 3, name: "Hương Ly", subtitle: "lyhuong.design@gmail.com", rating: 5, content: "Sống xa nhà, mỗi ngày ăn một mình rất dễ nhàm chán. App này gợi ý đa dạng, giúp mình khám phá nhiều món mới!", avatarColor: "bg-[#22c55e]", avatarText: "H" },
  { id: 4, name: "Quốc Khánh", subtitle: "khanh.dev99@gmail.com", rating: 4, content: "UI mượt, animation xúc xắc rất cuốn. Mình thích cách phân loại món ăn theo kiểu healthy, rất hợp với người đang ăn kiêng.", avatarColor: "bg-[#3b82f6]", avatarText: "Q" },
  { id: 5, name: "Mai Phương", subtitle: "phuongmai.home@gmail.com", rating: 5, content: "Từ ngày có web này, hai vợ chồng khỏi cãi nhau vụ tối nay ăn gì. Mình đánh giá 5 sao cho tính năng lọc giá cả!", avatarColor: "bg-[#ec4899]", avatarText: "M" }
];
...
function App() {
  ...
  // REF DÙNG ĐỂ CUỘN DANH SÁCH ĐÁNH GIÁ
  ...
  // HÀM XỬ LÝ CLICK MŨI TÊN CUỘN NGANG
  const scrollLeft = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-bgLight selection:bg-brand selection:text-white">
      ...
      <main id="hero" className="container mx-auto px-6 py-10 md:py-20 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="w-full md:w-1/2 relative">
          ...
          <button 
            ...
            className={`absolute -bottom-6 right-0 md:-bottom-12 md:-right-8 z-20 ${randomFood ? 'bg-white text-brand' : 'bg-orange-400 text-yellow-900'} font-extrabold px-8 py-5 md:px-10 md:py-6 rounded-full flex items-center gap-3 md:gap-4 shadow-[0_20px_50px_rgba(0,0,0,0.4)] hover:scale-110 transition-all outline-none border-4 border-white`}
          >
      ...
      {/* Testimonials Section - ĐÃ THÊM MŨI TÊN ĐIỀU HƯỚNG */}
      <section id="testimonials" className="bg-white py-20 scroll-mt-10 overflow-hidden">
        <div className="container mx-auto px-6 relative">
          ...
          <div className="text-center mb-12 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            {/* HAI NÚT MŨI TÊN NẰM Ở GÓC TRÊN CÙNG BÊN PHẢI */}
          ...
          {/* CẮM REF VÀO ĐÂY ĐỂ ĐIỀU KHIỂN CUỘN */}
            ...
            {testimonials.map((item) => (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className={`w-14 h-14 rounded-full ${item.avatarColor} flex items-center justify-center text-white font-bold text-xl shadow-inner`}>
                    {item.avatarText}
                  </div>
                  <div className="flex-1 overflow-hidden">
                    <h4 className="font-bold text-textDark text-lg truncate">{item.name}</h4>
                    {/* HIỂN THỊ EMAIL (SUBTITLE) CHUẨN XÁC */}
                    <p className="text-textGray text-sm truncate">{item.subtitle}</p>
                  </div>
                </div>
                {/* HIỂN THỊ LUÔN SỐ SAO ĐÁNH GIÁ */}
