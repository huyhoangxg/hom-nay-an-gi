  ...
  const handleRandomize = () => {
    ...
    const spinInterval = setInterval(() => {
      ...
      if (count > 15) {
        ...
        setRandomFood(`Hôm nay ăn: ${finalItem.name} 🤤`);
      }
    }, 100);
  };
    ...
    <div className="min-h-screen flex flex-col font-sans bg-bgLight selection:bg-brand selection:text-white">
      ...
      <main id="hero" className="container mx-auto px-6 py-10 md:py-20 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div className="w-full md:w-1/2 flex flex-col items-start gap-6">
          ...
          <button onClick={() => scrollToSection('features')} className="mt-4 bg-brand hover:bg-[#e05e10] text-white font-semibold py-3.5 px-8 rounded-full shadow-lg shadow-orange-500/30 transition transform hover:-translate-y-1">
            Khám phá ngay
          </button>
        </div>
        
        <div className="w-full md:w-1/2 relative h-[450px] md:h-[600px] rounded-[32px] overflow-hidden shadow-2xl">
          ...
          {/* NÚT RANDOM ĐÃ ĐƯỢC LÀM TO HƠN VÀ NỔI BẬT HƠN */}
          <button 
            onClick={handleRandomize} 
            className={`absolute bottom-6 right-6 md:bottom-10 md:right-10 ${randomFood ? 'bg-white text-brand' : 'bg-yellow-400/90 text-yellow-900'} backdrop-blur-md font-extrabold px-8 py-5 md:px-10 md:py-6 rounded-full flex items-center gap-3 md:gap-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:scale-110 transition-all outline-none border-4 border-white/40`}
          >
      ...
      <section id="team" className="bg-white py-24 scroll-mt-20 border-b border-gray-100">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center">
            {/* Các thành viên... */}
            <div className="group"><div className="w-32 h-32 mx-auto rounded-full overflow-hidden mb-6 shadow-xl border-4 border-white"><img src="https://i.pravatar.cc/150?img=11" alt="Thành viên" className="w-full h-full object-cover" /></div><h4 className="text-xl font-bold mb-1">Hải Anh</h4><p className="text-brand text-sm">Founder & Developer</p></div>
            <div className="group"><div className="w-32 h-32 mx-auto rounded-full overflow-hidden mb-6 shadow-xl border-4 border-white"><img src="https://i.pravatar.cc/150?img=60" alt="Thành viên" className="w-full h-full object-cover" /></div><h4 className="text-xl font-bold mb-1">Tuấn Kiệt</h4><p className="text-brand text-sm">Mobile Developer</p></div>
            <div className="group"><div className="w-32 h-32 mx-auto rounded-full overflow-hidden mb-6 shadow-xl border-4 border-white"><img src="https://i.pravatar.cc/150?img=5" alt="Thành viên" className="w-full h-full object-cover" /></div><h4 className="text-xl font-bold mb-1">Bảo Thy</h4><p className="text-brand text-sm">UI/UX Designer</p></div>
            <div className="group"><div className="w-32 h-32 mx-auto rounded-full overflow-hidden mb-6 shadow-xl border-4 border-white"><img src="https://i.pravatar.cc/150?img=12" alt="Thành viên" className="w-full h-full object-cover" /></div><h4 className="text-xl font-bold mb-1">Gia Bảo</h4><p className="text-brand text-sm">Backend & Data</p></div>
            ...
            <div className="group">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-1">Bảo Thy</h4>
