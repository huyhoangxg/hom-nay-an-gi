...
const INITIAL_TESTIMONIALS = [
  ...
  { id: 4, name: "Quốc Khánh", subtitle: "Lập trình viên", rating: 4, content: "UI mượt, animation xúc xắc rất cuốn. Mình thích cách phân loại món ăn theo kiểu healthy, rất hợp với người đang ăn kiêng.", avatarColor: "bg-[#3b82f6]", avatarText: "QK" },
  { id: 5, name: "Mai Phương", subtitle: "Nội trợ", rating: 5, content: "Từ ngày có web này, hai vợ chồng khỏi cãi nhau vụ tối nay ăn gì. Mình đánh giá 5 sao cho tính năng lọc giá cả!", avatarColor: "bg-[#ec4899]", avatarText: "MP" }
];
...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-bgLight selection:bg-brand selection:text-white">
      ...
      {/* Testimonials Section - SCROLL NGANG */}
      <section id="testimonials" className="bg-white py-20 scroll-mt-10 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          {/* Vùng chứa cuộn ngang (ẩn thanh cuộn mặc định, kéo mượt) */}
          <div className="flex overflow-x-auto gap-6 pb-8 pt-4 snap-x snap-mandatory scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            {/* Lấy TOÀN BỘ đánh giá ra để lướt thay vì chỉ 3 cái như trước */}
          ...
          {/* Hướng dẫn vuốt (Dành cho Mobile) */}
