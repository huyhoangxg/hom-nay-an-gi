              ...
              {testimonials.length === 0 ? (
                ...
                testimonials.map((item) => (
                  ...
                  >
                    ...
                    {item.image_url && (
                      <div className="mt-6 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 flex justify-center">
                        <img src={item.image_url} alt="Review attachment" className="w-full h-48 sm:h-56 object-contain hover:scale-105 transition-transform duration-500" />
                      </div>
                    )}
                  </div>
                ))
